...
export class PedidoService {
  ...
  getPedido(pedido_id: string): Observable<Pedido> {
  ...
  updateExistingPedido(pedido: Pedido, pedido_id: string): Observable<Pedido> {
  ...
  deleteExistingPedido(pedido_id: string): Observable<void> {
